...
import styles from "./StartingFragment.styles";

const StartingFragment: React.FunctionComponent = () => {
  ...
  return (
    <Box sx={styles.viewPort}>STARTING FRAGMENT IS GOING TO BE HERE ONE DAY</Box>
  );
};

export default StartingFragment;
